...
# Define the function
 ...
 name = (label_name_tag)
 print(name)
 birthdate = (label_dob_tag)
 print(birthdate)
 code = (label_pin_tag)
 print(code)
 address = (label_address_tag)
 print(address)
 vehicle_type = (label_vehicle_type_tag)
 print(vehicle_type)
 
 label_id_tag = str(license)
 label_name_tag = str(name)
 label_dob_tag = str(birthdate)
 label_pin_tag = str(code)
 label_address_tag = str(address)
 label_vehicle_type_tag = str(vehicle_type)
